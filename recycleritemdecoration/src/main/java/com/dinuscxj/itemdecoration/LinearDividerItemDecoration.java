...
public class LinearDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public static final int DIVIDER_TYPE_BOTH = 0;
    public static final int DIVIDER_TYPE_OFFSET = 1;
    public static final int DIVIDER_TYPE_DRAW = 2;
    ...
    public LinearDividerItemDecoration(Context context, @Orientation int orientation, int dividerType) {
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        if (dividerType != DIVIDER_TYPE_BOTH && dividerType != DIVIDER_TYPE_DRAW) {
            return;
        }
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        if (dividerType != DIVIDER_TYPE_BOTH && dividerType != DIVIDER_TYPE_OFFSET) {
            return;
        }
