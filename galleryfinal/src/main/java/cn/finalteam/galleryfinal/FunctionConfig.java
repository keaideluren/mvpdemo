...
public class FunctionConfig implements Cloneable{
    ...
    private FunctionConfig(final Builder builder) {
        this.pickMime = builder.pickMime;
    ...
    public static class Builder {
        private PickMime pickMime = PickMime.IMAGE;
        ...
        public Builder setPickMime(PickMime pickMime) {
            this.pickMime = pickMime;
            return this;
        }
