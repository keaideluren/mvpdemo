    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (GalleryFinal.getFunctionConfig() == null || GalleryFinal.getGalleryTheme() == null) {
            ...
            if (GalleryFinal.getFunctionConfig().isMutiSelect()) {
                ...
                mrlOk.setVisibility(View.VISIBLE);
            }
...
//        }
        ...
        mTvSubTitle.setText(GalleryFinal.getFunctionConfig().getPickMime() == FunctionConfig.PickMime.IMAGE ?
                R.string.all_photo : R.string.all_video);
    }
    ...
    private void findViews() {
        ...
        mrlOk = (RelativeLayout) findViewById(R.id.rl_preview);
        mivOk = (TextView) findViewById(R.id.iv_ok);
    }
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.fab_ok || id == R.id.iv_ok) {
    ...
    private void getPhotos() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                List<PhotoFolderInfo> allFolderList = null;
                if (GalleryFinal.getFunctionConfig().getPickMime() == FunctionConfig.PickMime.IMAGE) {
                    allFolderList = PhotoTools.getAllPhotoFolder(PhotoSelectActivity.this, mSelectPhotoList);
                } else if (GalleryFinal.getFunctionConfig().getPickMime() == FunctionConfig.PickMime.VIDEO) {
                    allFolderList = PhotoTools.getVideos(PhotoSelectActivity.this, mSelectPhotoList);
                }
                if (allFolderList == null) {
                    allFolderList = new ArrayList<PhotoFolderInfo>();
                }
