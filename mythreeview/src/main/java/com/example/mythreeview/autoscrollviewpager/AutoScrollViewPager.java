...
public class AutoScrollViewPager extends ViewPager {
    ...
    public void setIndicatior(final FlowIndicator indicator){
        indicator.setFocus(0);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if ( Math.abs(downY -touchY)> 120) {
          //  LogUtils.e("AutoScrollViewPager", "AutoScrollViewPager在上下滑动");
